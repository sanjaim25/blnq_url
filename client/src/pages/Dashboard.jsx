        ...
        <div style={{ display:'flex', alignItems:'center', gap:12, minWidth:0 }}>
          ...
          <div style={{ minWidth:0 }}>
            <div style={{ fontFamily:"'Playfair Display',serif", fontSize:'1rem', fontWeight:900, letterSpacing:'-0.02em', color:INK }}>
              ...
              <span style={{ fontFamily:"'Fragment Mono',monospace", fontSize:'0.8rem', color:'#8d8b94', marginLeft:8 }}>Blnq-url/{url.shortCode}</span>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <span style={{ position: 'absolute', left: 10, top: '50%', transform: 'translateY(-50%)', fontFamily: "'Fragment Mono',monospace", fontSize: '0.7rem', color: '#b0adb8', pointerEvents: 'none', zIndex: 1, userSelect: 'none' }}>Blnq-url/</span>
              ...
              <div style={{ background: '#fff', border: `1px solid ${LINE}`, borderRadius: 18, overflow: 'hidden', boxShadow: '0 4px 16px rgba(20,20,28,0.06)', animation: 'fadeUp .5s cubic-bezier(0.16,1,0.3,1) .4s both' }}>
                ...
                {urls.slice(0, 5).map((u, i) => (
                  <div key={u.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 18px', borderTop: i === 0 ? 'none' : `1px solid ${LINE}`, transition: 'background .15s' }} onMouseEnter={e => e.currentTarget.style.background = P2} onMouseLeave={e => e.currentTarget.style.background = ''}>
                    ...
                    <a href={`${base()}/${u.shortCode}`} target="_blank" rel="noopener noreferrer" style={{ fontFamily: "'Fragment Mono',monospace", fontSize: '0.8rem', fontWeight: 600, color: V, textDecoration: 'none', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>Blnq-url/{u.shortCode}</a>
