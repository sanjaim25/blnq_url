              ...
              <form onSubmit={submit} className="shorten-form-container" style={{ padding:'32px 40px' }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:16, marginBottom:20 }}>
                  ...
                  <Field label="Custom alias" hint="optional">
                    <div style={{ position:'relative' }}>
                      <span className="shorten-alias-prefix" style={{ position:'absolute', left:16, top:'50%', transform:'translateY(-50%)', fontFamily:"'Fragment Mono',monospace", fontSize:'0.8125rem', color:'#b0adb8', pointerEvents:'none', whiteSpace:'nowrap', fontWeight:500, zIndex:1, userSelect:'none' }}>Blnq-url/</span>
              ...
              <div style={{ background:'#fff', border:`1.5px solid ${V}35`, borderRadius:18, overflow:'hidden', boxShadow:`0 8px 32px ${V}18`, animation:'scaleSpring .4s cubic-bezier(0.34,1.56,0.64,1) both' }}>
                ...
                {activeTab === 'result' && (
                  <div style={{ padding:'22px' }}>
                    ...
                    <div style={{ display:'flex', flexWrap:'wrap', gap:7, marginTop:14 }}>
                      {result.expiresAt && <span style={{ padding:'3px 10px', background:AMB+'15', border:`1px solid ${AMB}30`, borderRadius:99, fontFamily:"'Space Grotesk',sans-serif", fontSize:'0.7rem', fontWeight:600, color:AMB }}><span style={{display:"flex",alignItems:"center",gap:4}}><Clock size={14} color="#15141c" strokeWidth={2.5} /> Expires </span>{fmtD(result.expiresAt)}</span>}
                      {result.password  && <span style={{ padding:'3px 10px', background:`${V}10`, border:`1px solid ${V}25`, borderRadius:99, fontFamily:"'Space Grotesk',sans-serif", fontSize:'0.7rem', fontWeight:600, color:V }}><span style={{display:"flex",alignItems:"center",gap:4}}><Lock size={12} color="#15141c" strokeWidth={2.5} /> Password protected</span></span>}
                ...
                {activeTab === 'qr' && (
                  <div style={{ padding:'22px', display:'flex', flexDirection:'column', alignItems:'center', gap:16 }}>
                    ...
                    <div style={{ fontFamily:"'Fragment Mono',monospace", fontSize:'0.8125rem', color:V, fontWeight:600 }}>Blnq-url/{result.shortCode}</div>
                    <button
                      onClick={() => {
